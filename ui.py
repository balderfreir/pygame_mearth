...
class UI:
    def __init__(self):
        ...
        self.magic_graphics = []
        for magic_item in magic_data.values():
            path = magic_item['graphic']
    ...
    def selection_box(self, left, top, has_switched):
        ...
        if has_switched:
            # выделяем бордер другим цветом во время смены оружия
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(100, 635, has_switched)  # for magic
    ...
    def display(self, player):
        ...
        self.magic_overlay(player.magic_index, not player.can_switch_weapon)
