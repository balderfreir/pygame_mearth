...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, obstacle_sprites, damage_player, trigger_deth_particles, add_exp):
        ...
        self.trigger_deth_particles = trigger_deth_particles
    ...
    def animate(self):  # almost the same 'def animate' in player.py
    ...
    def check_death(self):
        if self.health <= 0:
            ...
            self.trigger_deth_particles(self.rect.center, self.monster_name)
